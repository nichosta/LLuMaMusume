...
- Once a cinematic releases, the coordinator enforces a short post-release buffer (currently 2 additional turns) before handing control back to the agent so lingering fades or loading screens do not cause premature inputs.
